...
| `clean [tool] [--namespace <name>] [--all]`                                                                                                                                                                                  | Remove tool image(s). `--all` removes across all namespaces. No-arg form also removes base images, the proxy image, leftover proxy resources, all filesystem audit logs under `$AGENTIC_HOME/audit/`, and the `agentic-net` network                      |
