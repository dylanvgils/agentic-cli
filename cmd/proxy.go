...
// proxyRunCmd runs the egress forward proxy inside the proxy sidecar container. It
...
func init() {
	...
	proxyCmd.AddCommand(proxyBuildCmd, proxyUpdateCmd, proxyCleanCmd, proxyRunCmd)
...
func runProxyServer(_ *cobra.Command, _ []string) error {
